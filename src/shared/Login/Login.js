            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-white mx-auto py-7 dark:text-gray-100" >
                ...
                <form onSubmit={handleLogIn} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm form-control">
                        ...
                        <input type="email" name="email" id="username" placeholder="email" className="w-full px-4 py-3 rounded-md dark:border-gray-700  dark:text-gray-100 focus:dark:border-violet-400 shadow-gray-500 shadow-lg bg-gray-300" />
                    </div>
                    <div className="space-y-1 text-sm form-control">
                ...
                <div className="flex items-center pt-4 space-x-1">
                    ...
                    <p className="px-3 text-sm text-violet-400">Login with social accounts</p>
                    <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
                </div>
                <div className="flex justify-center space-x-4">
                    <button onClick={handlegoogle} aria-label="Log in with Google" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current text-red-500">
                ...
                <Link to='/register' className="text-sm w-full mx-auto hover:underline sm:px-6 text-blue-600 text-center">
                    <p className='text-blue-600 hover:underline'>Don't have an account?</p>
                </Link>
            </div>
        </section>
    );
