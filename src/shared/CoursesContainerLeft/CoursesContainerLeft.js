    ...
    return (
        <div className="max-w-xs rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100 mb-5">
            ...
            <div className="flex flex-col justify-between p-6 space-y-8">
                ...
                <Link className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-[#570DF8] text-white"><button type="button">Read more</button></Link>
            </div>
        </div>
    );
};
